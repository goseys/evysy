...
UUID=${UUID:-'efd35e33-1f29-441f-8061-5196ff1278c1'}
VMESS_WSPATH=${VMESS_WSPATH:-'/VGPVCmJEy5fVqgdU'}
VLESS_WSPATH=${VLESS_WSPATH:-'/Ed0XERSr6A6D6IO'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/1PUr7G5WXeB'}
SS_WSPATH=${SS_WSPATH:-'/CV6V3b4iqbvCd4jk'}
